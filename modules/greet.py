...
async def setwelcomechannel(ctx, channe_lid):
    ...
    try:
        ...
        embed = discord.Embed(
            title="Success!", description="The default welcome channel has been set!"
        )
...
async def deletewelcomechannel(ctx):
    ...
    try:
        embed = discord.Embed(
            title="Success!", description="The default welcome channel has been deleted!"
        )
        embed.set_footer(text="Thank you for using Catto Bot!")
...
async def setleavechannel(ctx, channe_lid):
    ...
    try:
        embed = discord.Embed(
            title="Success!", description="The default leave channel has been set!"
        )
        embed.set_footer(text="Thank you for using Catto Bot!")
...
async def deleteleavechannel(ctx):
    ...
    try:
        embed = discord.Embed(
            title="Success!", description="The default leave channel has been deleted!"
        )
        embed.set_footer(text="Thank you for using Catto Bot!")
