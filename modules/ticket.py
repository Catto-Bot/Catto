...
async def ticketsetup(ctx):
    ...
    embed = discord.Embed(
        ...
        description="Is this where you want to setup the ticket system?",
    )
    ...
    def check(reaction, user):
        return (
            user == ctx.author
            and reaction.message.id == ticketmessage.id
    ...
    try:
        ...
        if str(reaction.emoji) == "👍":
            ...
            if category:
                ...
                embed = discord.Embed(
                    title="Welcome to Catickets!", description="React to get started!"
                )
                embed.set_thumbnail(
                    ...
                    try:
                        ...
                        if str(reaction.emoji) == "🎟️":
                            if user.id in tickets:
                                hello = await ctx.send(
                                    f"{user.mention}, You already have a ticket!"
                                )
                                ...
                                embed = discord.Embed(
                                    title=f"Ticket With The Name {user.name} Has Been Created ",
                                    description=f"{user.mention}, Ping A Staff Or An Admin If You Need Help.",
