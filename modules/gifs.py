...
async def hug(ctx, member: commands.MemberConverter = None):
    ...
    if member:
        ...
        embed = discord.Embed(
            title=f"{ctx.author.display_name} hugs {member.display_name}! AWWWWW ❁◕ ‿ ◕❁",
...
async def slap(ctx, member: commands.MemberConverter = None):
    ...
    if member:
        ...
        json_hug_data = json.loads(hugr.text)
        embed = discord.Embed(
            title=f"{ctx.author.display_name} slaps {member.display_name}! OUCH ( ಥ۝ಥ )",
            color=discord.Color.dark_gray(),
        )
        embed.set_image(url=json_hug_data["link"])
        embed.set_footer(text="Thank You For Using Catto! :D")
...
async def kiss(ctx, member: commands.MemberConverter = None):
    ...
    if member:
        ...
        json_hug_data = json.loads(hugr.text)
        embed = discord.Embed(
            title=f"{ctx.author.display_name} kisses {member.display_name}! AWWWW (ᅌwᅌ)",
            color=discord.Color.dark_gray(),
        )
        embed.set_image(url=json_hug_data["link"])
        embed.set_footer(text="Thank You For Using Catto! :D")
...
async def bite(ctx, member: commands.MemberConverter = None):
    ...
    if member:
        ...
        embed = discord.Embed(
            title=f"{ctx.author.display_name} bites {member.display_name}! OUCH! (ಥ۝ಥ)",
            color=discord.Color.dark_gray(),
        )
...
async def lick(ctx, member: commands.MemberConverter = None):
    ...
    if member:
        ...
        embed = discord.Embed(
            title=f"{ctx.author.display_name} Licks {member.display_name}! AWWWWW! (✿ ♥‿♥)(♥ω♥*)",
            color=discord.Color.dark_gray(),
        )
...
async def bully(ctx, member: commands.MemberConverter = None):
    ...
    if member:
        ...
        embed = discord.Embed(
            title=f"{ctx.author.display_name} Bullied {member.display_name}!! (ಥ﹃ಥ)",
            color=discord.Color.dark_gray(),
        )
...
async def cuddle(ctx, member: commands.MemberConverter = None):
    ...
    if member:
        ...
        embed = discord.Embed(
            title=f"{ctx.author.display_name} cuddled {member.display_name}! ʕっ•ᴥ•ʔっ",
            color=discord.Color.dark_gray(),
        )
...
async def cry(ctx, member: commands.MemberConverter = None):
    ...
    if member:
        ...
        embed = discord.Embed(
            title=f"{member.display_name} made {ctx.author.display_name} cry! (っ- ‸ – ς)",
            color=discord.Color.dark_gray(),
        )
        ...
        embed = discord.Embed(
            title=f"{ctx.author.display_name} is crying! (っ- ‸ – ς)",
            color=discord.Color.dark_gray(),
        )
        embed.set_image(
            url="https://media.tenor.com/pRTPXrxI2UAAAAAS/crying-meme-black-guy-cries.gif"
        )
        await ctx.send(embed=embed)
...
async def pat(ctx, member: commands.MemberConverter = None):
    ...
    if member:
        ...
        embed = discord.Embed(
            title=f"{ctx.author.display_name} patted {member.display_name}! (づ｡◕‿‿◕｡)づ",
            color=discord.Color.dark_gray(),
        )
        ...
        embed = discord.Embed(
            title=f"{ctx.author.display_name} patted themselves! (づ｡◕‿‿◕｡)づ",
            color=discord.Color.dark_gray(),
        )
...
async def bonk(ctx, member: commands.MemberConverter = None):
    ...
    if member:
        ...
        embed = discord.Embed(
            title=f"{ctx.author.display_name} bonked {member.display_name}! (눈_눈)",
            color=discord.Color.dark_gray(),
        )
...
async def smug(ctx, member: commands.MemberConverter = None):
    ...
    if member:
        ...
        embed = discord.Embed(
            title=f"{member.display_name} got smugged by {ctx.author.display_name}! (￣‿￣)",
            color=discord.Color.dark_gray(),
        )
        ...
        embed = discord.Embed(
            title=f"{ctx.author.display_name} is smugging! (￣‿￣)", color=discord.Color.dark_gray()
        )
...
async def blush(ctx, member: commands.MemberConverter = None):
    ...
    if member:
        ...
        embed = discord.Embed(
            title=f"{ctx.author.display_name} made {member.display_name} blush! (⁄ ⁄•⁄ω⁄•⁄ ⁄)",
            color=discord.Color.dark_gray(),
        )
        ...
        embed = discord.Embed(
            title=f"{ctx.author.display_name} is blushing! (⁄ ⁄•⁄ω⁄•⁄ ⁄)",
            color=discord.Color.dark_gray(),
        )
...
async def wave(ctx, member: commands.MemberConverter = None):
    ...
    if member:
        ...
        embed = discord.Embed(
            title=f"{ctx.author.display_name} waved to {member.display_name}! (ﾉ◕ヮ◕)ﾉ*:･ﾟ✧",
            color=discord.Color.dark_gray(),
        )
        ...
        embed = discord.Embed(
            title=f"{ctx.author.display_name} waved at themselves! (ﾉ◕ヮ◕)ﾉ*:･ﾟ✧",
            color=discord.Color.dark_gray(),
        )
...
async def handhold(ctx, member: commands.MemberConverter = None):
    ...
    if member:
        ...
        embed = discord.Embed(
            title=f"{ctx.author.display_name} is holding hands with {member.display_name}! (づ｡◕‿‿◕｡)づ",
            color=discord.Color.dark_gray(),
        )
        ...
        embed = discord.Embed(
            title=f"{ctx.author.display_name} is holding their own hand! (づ｡◕‿‿◕｡)づ",
            color=discord.Color.dark_gray(),
        )
...
async def nom(ctx, member: commands.MemberConverter = None):
    ...
    if member:
        ...
        embed = discord.Embed(
            title=f"{ctx.author.display_name} is nomming {member.display_name}'s head! (ﾉ◕ヮ◕)ﾉ*:･ﾟ✧",
            color=discord.Color.dark_gray(),
        )
        ...
        embed = discord.Embed(
            title=f"{ctx.author.display_name} is nomming their own head! (ﾉ◕ヮ◕)ﾉ*:･ﾟ✧",
            color=discord.Color.dark_gray(),
        )
        embed.set_image(
            url="https://cdn.discordapp.com/emojis/749763703158734859.gif?size=128&quality=lossless"
        )
        await ctx.send(embed=embed)
...
async def kill(ctx, member: commands.MemberConverter = None):
    ...
    if member:
        ...
        embed = discord.Embed(
            title=f"{ctx.author.display_name} killed {member.display_name}! (⌐■_■)",
            color=discord.Color.dark_gray(),
        )
        ...
        embed = discord.Embed(
            title=f"{ctx.author.display_name} killed themselves! (⌐■_■)",
            color=discord.Color.dark_gray(),
        )
        await ctx.send(embed=embed)
...
async def wink(ctx, member: commands.MemberConverter = None):
    ...
    if member:
        ...
        embed = discord.Embed(
            title=f"{ctx.author.display_name} winked at {member.display_name}! (◕‿↼)",
            color=discord.Color.dark_gray(),
        )
        ...
        embed = discord.Embed(
            title=f"{ctx.author.display_name} winked at yourself! (◕‿↼)",
            color=discord.Color.dark_gray(),
        )
        await ctx.send(embed=embed)
...
async def poke(ctx, member: commands.MemberConverter = None):
    ...
    if member:
        ...
        embed = discord.Embed(
            title=f"{ctx.author.display_name} poked {member.display_name}! (＾◡＾)っ",
            color=discord.Color.dark_gray(),
        )
        ...
        embed = discord.Embed(
            title=f"{ctx.author.display_name} poked themselves! (＾◡＾)っ",
            color=discord.Color.dark_gray(),
        )
